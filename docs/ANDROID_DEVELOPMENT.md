...
This preserves procedural guidance from 2026-09-19. Active instructions are in
AGENTS.md and docs/product/AGENTS.md. The old ground rules and roadmap below are
historical, not precedence rules or mandatory pauses. Bundled campaign templates
contain mechanics only; they are not exclusively user-supplied.
